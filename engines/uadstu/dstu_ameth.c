...
static int dstu_asn1_pub_cmp(const EVP_PKEY *a, const EVP_PKEY *b)
{
    ...
    /*
     * We do not compare sboxes here because it will be done in params_cmp by
     * EVP API
     */
    ...
    case ASN1_PKEY_CTRL_PKCS7_SIGN:
        if (arg1 == 0) {
            ...
            PKCS7_SIGNER_INFO_get0_algs((PKCS7_SIGNER_INFO *)arg2,
                                        NULL, &alg1, &alg2);
            X509_ALGOR_set0(alg1, OBJ_nid2obj(NID_dstu34311), V_ASN1_NULL, 0);
            if (nid == NID_undef) {
                return (-1);
            }
...
int dstu_asn1_meth_init(void)
{
    ...
    EVP_PKEY_asn1_set_param(dstu_asn1_meth_le, dstu_asn1_param_decode,
                            ...
                            /* dstu_asn1_param_missing */ NULL,
                            dstu_asn1_param_copy, dstu_asn1_param_cmp,
    ...
    EVP_PKEY_asn1_set_public(dstu_asn1_meth_le, dstu_asn1_pub_decode,
                             dstu_asn1_pub_encode, dstu_asn1_pub_cmp,
                             dstu_asn1_pub_print, dstu_asn1_pkey_size,
                             dstu_asn1_pkey_bits);
