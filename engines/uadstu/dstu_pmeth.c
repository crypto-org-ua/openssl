                              ...
                              const char *value)
{
    ...
    if (!strcmp(SBOX_PARAM_STR, type)) {
        ...
        if (bn_encode(tmp, sbox, sizeof(sbox)))
            res =
                dstu_pkey_ctrl(ctx, DSTU_SET_CUSTOM_SBOX, sizeof(sbox), sbox);
        BN_free(tmp);
        return res;
    }
...
static int dstu_pkey_sign(EVP_PKEY_CTX *ctx, unsigned char *sig,
...
int dstu_pkey_meth_init(void)
{
    ...
    EVP_PKEY_meth_set_keygen(dstu_pkey_meth_le, /* dstu_pkey_keygen_init */
                             NULL, dstu_pkey_keygen);
    EVP_PKEY_meth_set_ctrl(dstu_pkey_meth_le, dstu_pkey_ctrl,
                           dstu_pkey_ctrl_str);
    EVP_PKEY_meth_set_sign(dstu_pkey_meth_le, /* dstu_pkey_sign_init */ NULL,
                           dstu_pkey_sign);
    EVP_PKEY_meth_set_verify(dstu_pkey_meth_le, /* dstu_pkey_verify_init */
                             NULL, dstu_pkey_verify);
    ...
    EVP_PKEY_meth_set_keygen(dstu_pkey_meth_be, /* dstu_pkey_keygen_init */
                             NULL, dstu_pkey_keygen);
    EVP_PKEY_meth_set_ctrl(dstu_pkey_meth_be, dstu_pkey_ctrl,
                           dstu_pkey_ctrl_str);
    EVP_PKEY_meth_set_sign(dstu_pkey_meth_be, /* dstu_pkey_sign_init */ NULL,
                           dstu_pkey_sign);
    EVP_PKEY_meth_set_verify(dstu_pkey_meth_be, /* dstu_pkey_verify_init */
                             NULL, dstu_pkey_verify);
